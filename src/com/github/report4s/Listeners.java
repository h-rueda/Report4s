...
// */
//class Listeners implements IReporter, ISuiteListener, ITestListener, IConfigurationListener {
//
//    /**
...
//
//    /**
//     * Whether an HTML table has been opened in the test report.
//     */
...
//                print_method_row(i+1, 0, "<span class=\"multiThread\">No support for multi-threaded tests</span>", null, "", suite_md.filename, Status.SKIPPED, Status.SKIPPED);
//        }
//    }
//    
//    /**
...
//        String icon = Utils.getIconImage(status);
//        String class_name = Utils.completeClassName("row_suite", status);
//        HtmlWriter.println(
//            "            <tr class=\"" + class_name + "\">" + "\n" +
//            "                <td align=\"center\">" + "\n" +
...
//            Status status,
//            Status suite_status) {
//        //Parse suite status to determine row class name
//        String class_name = Utils.completeClassName("row_test", suite_status);
