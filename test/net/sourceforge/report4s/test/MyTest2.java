...
public class MyTest2 {
	...
	public void search() {
		...
		Report4s.logEvent("send keys", false);
		elem.sendKeys("Hola");
		Report4s.logEvent("send keys", true);
		elem.sendKeys(" Mundo!");
		Report4s.logEvent("clear", false);
		elem.clear();
		Report4s.logEvent("send keys", true);
		elem.sendKeys("Adios Mundo!");

		elem = eventDriver.findElement(By.id("gender2"));
		Report4s.logEvent("click on gender2", false);
		elem.click();
		...
		Report4s.logEvent("click on vehicle2", false);
		elem.click();
		...
		Report4s.logEvent("click link", false);
		...
		Report4s.logEvent("click button", false);
		elem.click();
